...
'''
TMSD6 + dynamic_subdoc
- subdoc_path : tm_datasets/20NG/dynamic_subdoc/train_sub.npz  , 
                 tm_datasets/20NG/dynamic_subdoc/test_sub.npz    
- generate subdoc using: utils/dynamic_subdoc_prepare.py
'''
class ECR(nn.Module):
