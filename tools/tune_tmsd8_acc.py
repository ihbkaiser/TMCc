...
parser.add_argument('--data_path', type=str, default="baseline/tm_datasets/BBC_new", help="path to dataset")
parser.add_argument('--num_topics', type=int, default=50, help="number of topics")
parser.add_argument('--device', type=str, default=("cuda" if torch.cuda.is_available() else "cpu"), choices=['cuda:0', 'cuda:1', 'cpu'], help="compute device")
parser.add_argument('--project_name', type=str, default='BBC-50topic-classification-scores')
