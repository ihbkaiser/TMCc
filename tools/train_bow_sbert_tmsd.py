#!/usr/bin/env python3
"""
train_bow_sbert_tmsd.py — Train BoW SBert TMSD topic model end to end with sub-documents

Usage:
    python train_bow_sbert_tmsd.py
"""
...
from models.bow_sbert_tmsd import BoW_SBERT_TMSD
